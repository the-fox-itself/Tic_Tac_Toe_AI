...
public class Board {
    ...
    private boolean move (int x, int y) {
        ...
        if (gameOver) {
            throw new IllegalStateException("LazoCoder.TicTacToe is over. No moves can be played.");
        }
    ...
    public State getWinner () {
        if (!gameOver) {
            throw new IllegalStateException("LazoCoder.TicTacToe is not over yet.");
        }
        return winner;
    }
